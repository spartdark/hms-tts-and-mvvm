...
import com.spartdark.ttsandmvvm.R
import com.spartdark.ttsandmvvm.databinding.FragmentHomeBinding
...
class TextTospeechFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.textToSpeechViewModel = viewModel
    ...
    override fun onPause() {
        super.onPause()
        viewModel.controlTTSEngine("stop")
    }

    override fun onDestroy() {
        super.onDestroy()
        viewModel.controlTTSEngine("shutdown")
    }
}